...
public interface ItemMeta extends Cloneable, ConfigurationSerializable {
     ...
     * These objects should not be retained, it is best to get a new reference
     * each time you want to modify the item, since items may get copied as
     * they move around or spawn and get picked up.
     * <p>
     * If this item has no custom data, calling this will initialize custom
     * data for the item. Use hasData for an efficient pre-check if you
